...
electricity_meter = DEMO_HOUSE.register_device(entrance, Sensor("a2f8690f-2b3a-43cd-90b8-9deea98b42a7","MysticEnergy Innovations","Volt Watch Elite","Electricity Meter"))
...
temperatur_sensor = DEMO_HOUSE.register_device(master_bedroom, Sensor("4d8b1d62-7921-4917-9b70-bbd31f6e2e8e","AetherCorp","SmartTemp 42","Temperature Sensor"))
...
temperatur_sensor.add_measurement("°C")